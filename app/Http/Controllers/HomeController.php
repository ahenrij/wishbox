...
//        DB::enableQueryLog(); // Enable query log
        $wishes = DB::table('wishes')
                    ...
                    ->select('wish_boxes.title', 'wish_boxes.deadline', 'wishes.id', 'wishes.user_id', 'wishes.description', 'wishes.category_id', 'wishes.link', 'wishes.filename', 'categories.title as category')
