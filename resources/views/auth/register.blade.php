        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="uk-card uk-card-default uk-card-body">
                    <div class="ml-5">
                        <div class="uk-card-title">{{ __('Inscription') }}</div>
                        <small>Créez votre compte WishBox !</small>
                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="username" type="text"
                                           ...
                                           value="{{ old('username') }}" required autocomplete="username" placeholder="Ex : thefather13z" autofocus>
